...
class BeforeAfterTheme extends ThemeExtension<BeforeAfterTheme>
  ...
  ThemeExtension<BeforeAfterTheme> lerp(
    ...
    Object? lerpedTrackColor;
    if (trackColor is Color && other?.trackColor is Color) {
      lerpedTrackColor = Color.lerp(
        trackColor as Color?,
        other?.trackColor as Color?,
        t,
      );
    } else {
      lerpedTrackColor = t < 0.5 ? trackColor : other?.trackColor;
    }

    return BeforeAfterTheme(
      trackWidth: lerpDouble(trackWidth, other?.trackWidth, t),
      trackColor: lerpedTrackColor,
