...
class ParserException implements Exception {
  ...
  ParserException(this.message, {this.rawData, this.originalError});
...
class JsonParser<T> implements DataParser<T> {
  ...
  JsonParser(this.fromJson, {this.fallbackParser, this.debugMode = kDebugMode});
