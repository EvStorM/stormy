...
class AgreementCheckbox extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final resolvedCheckIcon = checkIcon ?? StormyUiConfig.assets?.checkIcon;
    final resolvedUncheckIcon =
        unCheckIcon ?? StormyUiConfig.assets?.unCheckIcon;
    ...
    return SizedBox(
      ...
      child: Icon(
        ...
        color: isChecked
            ...
            : (uncheckIconColor ??
                  StormyTheme.currentVariant.hintText.withAlpha(128)),
      ),
    );
  }
}
