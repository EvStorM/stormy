...
class EVDottedLineBorder extends BoxBorder {
  final double dottedLength;
  final double dottedSpace;

  const EVDottedLineBorder({
  ...
  const EVDottedLineBorder.fromBorderSide(
    BorderSide side, {
    this.dottedLength = 5,
    this.dottedSpace = 3,
  }) : top = side,
  ...
  const EVDottedLineBorder.symmetric({
  ...
  factory EVDottedLineBorder.all({
    ...
    return EVDottedLineBorder.fromBorderSide(
      side,
  ...
  static EVDottedLineBorder merge(EVDottedLineBorder a, EVDottedLineBorder b) {
    assert(BorderSide.canMerge(a.top, b.top));
    assert(BorderSide.canMerge(a.right, b.right));
    assert(BorderSide.canMerge(a.bottom, b.bottom));
    assert(BorderSide.canMerge(a.left, b.left));
    return EVDottedLineBorder(
  ...
  BoxBorder? add(ShapeBorder other, {bool reversed = false}) {
    if (other is EVDottedLineBorder &&
      ...
      return EVDottedLineBorder.merge(this, other);
    }
    return null;
  }
