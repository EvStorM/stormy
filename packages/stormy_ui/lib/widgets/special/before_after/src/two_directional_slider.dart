...
class _TwoDirectionalSliderState extends State<TwoDirectionalSlider> {
  ...
  void initState() {
    super.initState();
    _currentVerticalDragValue = _convertVerticalValue(
      widget.initialVerticalValue,
    );
    _currentHorizontalDragValue = _convertHorizontalValue(
      widget.initialHorizontalValue,
    );
  }
