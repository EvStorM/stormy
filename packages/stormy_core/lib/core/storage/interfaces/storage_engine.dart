...
abstract class IStorageEngine {
  ...
  /// 写入键值对
  Future<void> set(Object key, dynamic value, {required String bucketName});
  ...
  /// A移除某个已存储的键
  Future<void> remove(Object key, {required String bucketName});

  /// 批量删除
  Future<void> removeMany(List<Object> keys, {required String bucketName});
...
/// Hive keys are strings or integers; their types must survive enumeration.
void validateStorageKey(Object key) {
