...
abstract class AppLocalizations {
  ...
  /// No description provided for @example_translations_badge.
  ///
  /// In zh_CN, this message translates to:
  /// **'角标'**
  String get example_translations_badge;

  /// A plural message
  ///
  /// In zh_CN, this message translates to:
  /// **'{count, plural, =0{没有袋熊} =1{1只袋熊} other{{count}只袋熊}}'**
  String example_translations_n_wombats(int count);

  /// A gendered message
  ///
  /// In zh_CN, this message translates to:
  /// **'{gender, select, male{他} female{她} other{他/她}}'**
